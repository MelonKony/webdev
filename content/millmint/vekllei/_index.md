...
{{< hint warning >}}
🌺 This article is about [**Hobart's utopia**](/millmint/intro)
{{< /hint >}}
...
{{<columns>}}
<span class="fc">V</span>
**ekllei** sits atop the constructive boundary of the Mid-Atlantic ridge, bridging the North American and the Eurasian tectonic plates. The country is also situated between the North Atlantic and Arctic oceans, although the entirety of the Home Island is situated beneath the arctic circle. Despite this, the extreme latitude of inhabited areas means daylight is highly seasonal in the county, with dark winters and summer solstices that provide 23 consecutive hours of daylight.
<--->
...
2. **Crown Land**, or *Kronaismioudelfia*, are nongovernmental territories of natural reservation. Although similar in some ways to nature reserves or national parks, their legal status in Vekllei is somewhat more complex; although *de facto* part of the country, the government does not recognise human sovereignty over these regions, a feature inherited from [Upen](/millmint/vekllei/religion).
...
These features manifest in various forms throughout modern Vekllei, including its moneylessness, place-metaphysics, and personal freedoms. Its association with the Rebirth of Vekllei, characterised as female in [Upen](/millmint/vekllei/religion), gave the document its colloquial name *Petticoat Constitution*, after its provisions for women in democratic Vekllei society.
...
lthough a major power, Vekllei has an unusual hybrid market system called the *Vekllei Bureau System* (known colloquially as *Petticoat Socialism*), which uses both state-owned socialist centralism and deregulated syndicalism to benefit a free informal market system. Most unique about the Vekllei economy is its functional moneylessness, in which domestic society has abolished currency. No widespread currency substitutes exist.
<--->
...
*[Main Article: Language in Vekllei](/millmint/vekllei/language/)*

Modern Vekllei language (referred to simply as ***Vekllei***) is the national language of the country and spoken universally within the Home Islands and Vekllei's various Atlantic possessions. It is notable for its varied sublanguages, which include a signed language called [*Upotenne*](/millmint/vekllei/language/#6-upotenne) and various extant utility scripts.
...
*[Main Article: Religion in Vekllei](/millmint/vekllei/religion/)*
